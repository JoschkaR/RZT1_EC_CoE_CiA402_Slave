...
******************************************************************************/
int32_t sflash_erase_sector(uint32_t addr, uint32_t data_width, uint32_t addr_mode) __attribute__ ((section (".loader_text2")));
int32_t sflash_byte_program(uint32_t addr, uint8_t *buf, int32_t size, uint32_t data_width, uint32_t addr_mode) __attribute__ ((section (".loader_text2")));
int32_t sflash_spibsc_transfer(st_spibsc_spimd_reg_t *regset) __attribute__ ((section (".loader_text2")));
int32_t sflash_ctrl_protect(uint32_t req, uint32_t data_width) __attribute__ ((section (".loader_text2")));

/******************************************************************************
* Function Name: sflash_erase_sector
...
/******************************************************************************
* Function Name: sflash_byte_program
...
******************************************************************************/
int32_t sflash_byte_program(uint32_t addr, uint8_t *buf, int32_t size,
...
/******************************************************************************
* Function Name: sflash_spibsc_transfer
...
/******************************************************************************
* Function Name: sflash_ctrl_protect
