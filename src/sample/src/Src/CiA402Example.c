...
{
/* return if no input data is mapped*/
    if(sTxPDOassign.u16SubIndex0 == 0)
    {
        return;
    }

    /* map the data of the first axis*/
    if(sTxPDOassign.aEntries[0] == 0x1A00) /* dynamic csp/csv process data is mapped*/
    {
    ...
    else if(sTxPDOassign.aEntries[0] == 0x1A01) /* csp process data is mapped*/
    {
        /*the PDO mapping content is fixed so the variables can accessed directly*/
...
void APPL_OutputMapping(UINT16* pData)
{
       ...
       /* return if no output data is mapped*/
    if(sRxPDOassign.u16SubIndex0 == 0)
    {
        return;
    }

    /* map the data of the first axis*/
    if(sRxPDOassign.aEntries[0] == 0x1600) /* dynamic csp/csv process data is mapped*/
    {
        /*the PDO mapping content is fixed so the variables can accessed directly*/
    ...
    else if(sRxPDOassign.aEntries[0] == 0x1601) /* csp process data is mapped*/
    {
        /*the PDO mapping content is fixed so the variables can accessed directly*/
