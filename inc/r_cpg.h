...
*******************************************************************************/
void cpg_write_enable(void) __attribute__ ((section (".loader_text2")));
void cpg_write_disable(void) __attribute__ ((section (".loader_text2")));
void cpg_pll_wait(void) __attribute__ ((section (".loader_text2")));
